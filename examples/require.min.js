    ...
    return (
      e &&
        eachProp(e, function (e, t) {
          (!r && hasProp(i, t)) ||
            (!n || 'object' != typeof e || !e || isArray(e) || isFunction(e) || e instanceof RegExp
              ? (i[t] = e)
  ...
  if (void 0 === define) {
    ...
    void 0 === require || isFunction(require) || ((cfg = require), (require = void 0)),
      ...
      (req.createNode = function (e, t, i) {
        ...
        return (
          (r.type = e.scriptType || 'text/javascript'), (r.charset = 'utf-8'), (r.async = !0), r
        );
      }),
      (req.load = function (t, i, r) {
        ...
        if (isBrowser)
          return (
            ...
            !e.attachEvent ||
            (e.attachEvent.toString && e.attachEvent.toString().indexOf('[native code') < 0) ||
            isOpera
        ...
        if (isWebWorker)
          try {
            ...
            t.onError(
              makeError('importscripts', 'importScripts failed for ' + i + ' at ' + r, e, [i])
            );
          }
      }),
      isBrowser &&
    ...
    function R() {
      ...
      if (!i) {
        if (
          ...
          return (
            ((e = makeError('timeout', 'Load timeout for modules: ' + o, null, o)).contextName =
              l.contextName),
            O(e)
          );
        u &&
                ...
                : ((a[e] = !0),
                  each(o.depMaps, function (e, t) {
                    ...
                    !r ||
                      o.depMatched[t] ||
                      s[i] ||
                      (getOwn(a, i) ? (o.defineDep(t, m[i]), o.check()) : n(r, a, s));
                  }),
                  (s[e] = !0));
            })(e, {}, {});
          }),
            ...
            if (this.inited) {
              if (this.error) this.emit('error', this.error);
                ...
                if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
                  ...
                  if (
                    ((this.exports = n),
                    this.map.isDefine && !this.ignore && ((m[i] = n), req.onResourceLoad))
                  ) {
                    var a = [];
                  ...
                  : (((o = bind(this, function (e) {
                    ...
                    (o.fromText = bind(this, function (e, t) {
                      ...
                      try {
                        ...
                        return O(
                          makeError('fromtexteval', 'fromText eval for ' + c + ' failed: ' + e, e, [
                            c,
                          ])
                        );
                      }
      ...
      ((l = {
        ...
        nameToUrl: function (e, t, i) {
          ...
          if (req.jsExtRegExp.test(e)) a = e + (t || '');
            ...
            (a = n.join('/')),
              (a =
                ('/' === (a += t || (/^data\:|^blob\:|\?/.test(a) || i ? '' : '.js')).charAt(0) ||
                a.match(/^[\w\+\.\-]+:/)
                  ? ''
                  : g.baseUrl) + a);
          }
          ...
          if (!w(i.id)) {
            ...
            return (
              ...
              O(
                makeError(
                  'scripterror',
                  'Script error for "' + i.id + (r.length ? '", needed by: ' + r.join(', ') : '"'),
                  e,
                  [i.id]
                )
              )
