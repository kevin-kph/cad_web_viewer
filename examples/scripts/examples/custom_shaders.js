import { s as TextureTiling, t as TextureInterpolation, u as TextureMipMapping, v as TextureParameterization, w as TextureModifier, x as LinePatternLengthUnit, y as ImageFormat } from "../WebViewer.js";
import { i as i$1, n, a as i$2, b, t as t$1, r, A, e, g as getService, c as registerService, M as MaterialService } from "../hoops-ifc-relationship.js";
...
let HoopsMeshElementDescriptionElement = class extends i$2 {
  constructor() {
    super();
    this.vertexCount = 0;
  ...
  render() {
    return b`<div>
      <div class="value-row">
        <p class="name">Vertex Count:</p>
        <span class="value">${this.vertexCount}</span>
      </div>
      <div class="value-row">
        <p class="name">Element Count:</p>
        <span class="value">${this.elementCount}</span>
      </div>
      <div class="value-row">
        <p class="name">Has Normals:</p>
        <input class="value" type="checkbox" ?checked=${this.hasNormals} disabled />
      </div>
      <div class="value-row">
        <p class="name">Has UVs:</p>
        <input class="value" type="checkbox" ?checked=${this.hasUVs} disabled />
      </div>
      <div class="value-row">
        <p class="name">Has RGBAs:</p>
        <input class="value" type="checkbox" ?checked=${this.hasRGBAs} disabled />
      </div>
    </div>`;
  }
};
HoopsMeshElementDescriptionElement.styles = [
  i$1`
      :host {
        display: block;
      }
...
__decorateClass$5([
  n({ type: Number })
], HoopsMeshElementDescriptionElement.prototype, "vertexCount", 2);
__decorateClass$5([
  n({ type: Boolean })
], HoopsMeshElementDescriptionElement.prototype, "hasNormals", 2);
__decorateClass$5([
  n({ type: Boolean })
], HoopsMeshElementDescriptionElement.prototype, "hasUVs", 2);
__decorateClass$5([
  n({ type: Boolean })
], HoopsMeshElementDescriptionElement.prototype, "hasRGBAs", 2);
__decorateClass$5([
  n({ type: Number })
], HoopsMeshElementDescriptionElement.prototype, "elementCount", 2);
HoopsMeshElementDescriptionElement = __decorateClass$5([
  t$1("hoops-mesh-element-description")
], HoopsMeshElementDescriptionElement);
...
let HoopsMeshDescriptionElement = class extends i$2 {
  connectedCallback() {
    super.connectedCallback();
    if (!this.service || this.nodeId === void 0) {
      return;
    }
    this.service.getMeshDescription(this.nodeId).then((description) => {
  ...
  update(changedProperties) {
    ...
    if (changedProperties.has("nodeId") || changedProperties.has("service")) {
      if (!this.service) {
        return;
      }
      if (this.nodeId === void 0) {
        this.meshDescription = void 0;
        return;
      }
      this.service.getMeshDescription(this.nodeId).then((description) => {
        this.meshDescription = description;
  ...
  render() {
    ...
    if (this.nodeId === void 0) {
      return b`<div>No node ID provided.</div>`;
    }
    if (!this.meshDescription) {
      return b`<div>Loading mesh description...</div>`;
    }
    return b`<div>
      <h3 class="node-id">Node ID: ${this.nodeId}</h3>
      <hoops-accordion>
        <span slot="header">Faces</span>
        <hoops-mesh-element-description
          .vertexCount=${this.meshDescription.faces.vertexCount}
          .elementCount=${this.meshDescription.faces.elementCount}
          ?hasNormals=${this.meshDescription.faces.hasNormals}
          ?hasUVs=${this.meshDescription.faces.hasUVs}
          ?hasRGBAs=${this.meshDescription.faces.hasRGBAs}
          slot="content"
        ></hoops-mesh-element-description>
      </hoops-accordion>
      <hoops-accordion>
        <span slot="header">Lines</span>
        <hoops-mesh-element-description
          .vertexCount=${this.meshDescription.lines.vertexCount}
          .elementCount=${this.meshDescription.lines.elementCount}
          ?hasNormals=${this.meshDescription.lines.hasNormals}
          ?hasUVs=${this.meshDescription.lines.hasUVs}
          ?hasRGBAs=${this.meshDescription.lines.hasRGBAs}
          slot="content"
        ></hoops-mesh-element-description>
      </hoops-accordion>
      <hoops-accordion>
        <span slot="header">Points</span>
        <hoops-mesh-element-description
          .vertexCount=${this.meshDescription.points.vertexCount}
          .elementCount=${this.meshDescription.points.elementCount}
          ?hasNormals=${this.meshDescription.points.hasNormals}
          ?hasUVs=${this.meshDescription.points.hasUVs}
          ?hasRGBAs=${this.meshDescription.points.hasRGBAs}
          slot="content"
        ></hoops-mesh-element-description>
      </hoops-accordion>
    </div>`;
...
HoopsMeshDescriptionElement.styles = [
  i$1`
      :host {
        display: block;
      }
      ...
      .node-id {
        font-weight: bold;
        margin: 0;
        background-color: var(--hoops-svg-accent-color, #1181d7);
        color: var(--hoops-svg-fill-color, #f0f0f0);
        padding: 0.5rem;
      }
    `
];
__decorateClass$4([
  n({ type: Number })
], HoopsMeshDescriptionElement.prototype, "nodeId", 2);
__decorateClass$4([
  n({ type: Object, attribute: false })
], HoopsMeshDescriptionElement.prototype, "service", 2);
__decorateClass$4([
  r()
], HoopsMeshDescriptionElement.prototype, "meshDescription", 2);
HoopsMeshDescriptionElement = __decorateClass$4([
  t$1("hoops-mesh-description")
], HoopsMeshDescriptionElement);
...
function formatLinePatternLengthUnit(unit) {
  switch (unit) {
    case LinePatternLengthUnit.Object:
      return "object";
    case LinePatternLengthUnit.World:
      return "world";
    case LinePatternLengthUnit.ProportionOfScreenWidth:
      return "proportion-of-screen-width";
    case LinePatternLengthUnit.ProportionOfScreenHeight:
      return "proportion-of-screen-height";
  }
  return "N/A";
}
function formatTextureTiling(tiling) {
  switch (tiling) {
    case TextureTiling.Repeat:
      return "repeat";
    case TextureTiling.Trim:
      return "trim";
    case TextureTiling.Clamp:
      return "clamp";
  }
  return "N/A";
}
function formatTextureInterpolation(interpolation) {
  if (interpolation === TextureInterpolation.On) {
    return b`<input type="checkbox" checked disabled />`;
  }
  return b`<input type="checkbox" disabled />`;
}
function formatTextureMipMapping(mipMapping) {
  if (mipMapping === TextureMipMapping.On) {
    return b`<input type="checkbox" checked disabled />`;
  }
  return b`<input type="checkbox" disabled />`;
}
function formatTextureParameterization(parameterization) {
  switch (parameterization) {
    case TextureParameterization.UV:
      return "uv";
  }
  return "N/A";
}
function formatTextureModifier(modifier) {
  switch (modifier) {
    case TextureModifier.None:
      return "none";
    case TextureModifier.Decal:
      return "decal";
  }
  return "N/A";
}
let HoopsMaterialDescriptionElement = class extends i$2 {
  connectedCallback() {
    super.connectedCallback();
    if (!this.service || this.nodeId === void 0) {
      return;
    }
    this.service.getMaterialDescription(this.nodeId).then((description) => {
  ...
  update(changedProperties) {
    ...
    if (changedProperties.has("nodeId") || changedProperties.has("service")) {
      ...
      if (this.nodeId === void 0) {
        this.materialDescription = void 0;
        return;
      }
      this.service.getMaterialDescription(this.nodeId).then((description) => {
        this.materialDescription = description;
  ...
  render() {
    ...
    if (!this.materialDescription) {
      return b`<div>Loading material description...</div>`;
    }
    return b`<div>
      <div class="value-row">
        <p class="name">Is PBR:</p>
        <input
          class="value"
          type="checkbox"
          ?checked=${this.materialDescription.isPbr}
          disabled
          data-testid="is-pbr"
        />
      </div>
      <div class="value-row">
        <p class="name">Face Color:</p>
        <span class="value" data-testid="face-color"
          >${this.materialDescription.faceColor ? `[${this.materialDescription.faceColor.r}, ${this.materialDescription.faceColor.g}, ${this.materialDescription.faceColor.b}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Line Color:</p>
        <span class="value" data-testid="line-color"
          >${this.materialDescription.lineColor ? `[${this.materialDescription.lineColor.r}, ${this.materialDescription.lineColor.g}, ${this.materialDescription.lineColor.b}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Point Color:</p>
        <span class="value" data-testid="point-color"
          >${this.materialDescription.pointColor ? `[${this.materialDescription.pointColor.r}, ${this.materialDescription.pointColor.g}, ${this.materialDescription.pointColor.b}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Specular Color:</p>
        <span class="value" data-testid="specular-color"
          >${this.materialDescription.specularColor ? `[${this.materialDescription.specularColor.r}, ${this.materialDescription.specularColor.g}, ${this.materialDescription.specularColor.b}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Ambient Color:</p>
        <span class="value" data-testid="ambient-color"
          >${this.materialDescription.ambientColor ? `[${this.materialDescription.ambientColor.r}, ${this.materialDescription.ambientColor.g}, ${this.materialDescription.ambientColor.b}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Emissive Color:</p>
        <span class="value" data-testid="emissive-color"
          >${this.materialDescription.emissiveColor ? `[${this.materialDescription.emissiveColor.r}, ${this.materialDescription.emissiveColor.g}, ${this.materialDescription.emissiveColor.b}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Metallic:</p>
        <span class="value" data-testid="metallic"
          >${this.materialDescription.metallic !== void 0 ? this.materialDescription.metallic : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Roughness:</p>
        <span class="value" data-testid="roughness"
          >${this.materialDescription.roughness !== void 0 ? this.materialDescription.roughness : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Opacity:</p>
        <span class="value" data-testid="opacity"
          >${this.materialDescription.opacity !== void 0 ? this.materialDescription.opacity : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Specular Intensity:</p>
        <span class="value" data-testid="specular-intensity"
          >${this.materialDescription.specularIntensity !== void 0 ? this.materialDescription.specularIntensity : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Texture Flags:</p>
        ${this.materialDescription.textureFlags ? b`<div class="sub-value">
              <div class="value-row">
                <p class="name">Texture Tiling:</p>
                <span class="value" data-testid="texture-tiling"
                  >${formatTextureTiling(this.materialDescription.textureFlags.tiling)}</span
                >
              </div>
              <div class="value-row">
                <p class="name">Texture Interpolation:</p>
                <span class="value" data-testid="texture-interpolation"
                  >${formatTextureInterpolation(
      this.materialDescription.textureFlags.interpolation
    )}</span
                >
              </div>
              <div class="value-row">
                <p class="name">Texture MipMapping:</p>
                <span class="value" data-testid="texture-mipmapping"
                  >${formatTextureMipMapping(
      this.materialDescription.textureFlags.mipMapping
    )}</span
                >
              </div>
              <div class="value-row">
                <p class="name">Texture Parameterization:</p>
                <span class="value" data-testid="texture-parameterization"
                  >${formatTextureParameterization(
      this.materialDescription.textureFlags.parameterization
    )}</span
                >
              </div>
              <div class="value-row">
                <p class="name">Texture Modifier:</p>
                <span class="value" data-testid="texture-modifier"
                  >${formatTextureModifier(this.materialDescription.textureFlags.modifier)}</span
                >
              </div>
            </div>` : b`<span class="value">N/A</span>`}
      </div>
      <div class="value-row">
        <p class="name">Texture Matrix:</p>
        <span class="value" data-testid="texture-matrix"
          >${this.materialDescription.textureMatrix !== void 0 ? `[${this.materialDescription.textureMatrix.m.join(", ").substring(0, 10)}...]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Color Map:</p>
        <span class="value" data-testid="color-map"
          >${this.materialDescription.colorMap !== void 0 ? `[${this.materialDescription.colorMap.join(", ")}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Normal Map:</p>
        <span class="value" data-testid="normal-map"
          >${this.materialDescription.normalMap !== void 0 ? `[${this.materialDescription.normalMap.join(", ")}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Emissive Map:</p>
        <span class="value" data-testid="emissive-map"
          >${this.materialDescription.emissiveMap !== void 0 ? `[${this.materialDescription.emissiveMap.join(", ")}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Metallic Roughness Map:</p>
        <span class="value" data-testid="metallic-roughness-map"
          >${this.materialDescription.metallicRoughnessMap !== void 0 ? `[${this.materialDescription.metallicRoughnessMap.join(", ")}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Occlusion Map:</p>
        <span class="value" data-testid="occlusion-map"
          >${this.materialDescription.occlusionMap !== void 0 ? `[${this.materialDescription.occlusionMap.join(", ")}]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Line Pattern:</p>
        <span class="value" data-testid="line-pattern"
          >${this.materialDescription.linePattern !== void 0 ? `[${this.materialDescription.linePattern.join(", ").substring(0, 10)}...]` : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Line Pattern Length:</p>
        <span class="value" data-testid="line-pattern-length"
          >${this.materialDescription.linePatternLength !== void 0 ? this.materialDescription.linePatternLength : "N/A"}</span
        >
      </div>
      <div class="value-row">
        <p class="name">Line Pattern Length Unit:</p>
        <span class="value" data-testid="line-pattern-length-unit"
          >${formatLinePatternLengthUnit(this.materialDescription.linePatternLengthUnit)}</span
        >
      </div>
    </div>`;
  }
};
HoopsMaterialDescriptionElement.styles = [
  i$1`
      :host {
        display: block;
      }
...
__decorateClass$3([
  n({ type: Number })
], HoopsMaterialDescriptionElement.prototype, "nodeId", 2);
__decorateClass$3([
  n({ type: Object, attribute: false })
], HoopsMaterialDescriptionElement.prototype, "service", 2);
__decorateClass$3([
  r()
], HoopsMaterialDescriptionElement.prototype, "materialDescription", 2);
HoopsMaterialDescriptionElement = __decorateClass$3([
  t$1("hoops-material-description")
], HoopsMaterialDescriptionElement);
...
let HoopsCustomShaderPanelElement = class extends i$2 {
  constructor() {
    super(...arguments);
    this.selectedNodeIds = [];
    this.setShaderResult = { status: "none", message: "" };
    this.handleSelectionChange = () => {
      this.selectedNodeIds = this.service.getSelectedNodeIds();
    };
  }
  get lastSelectedNodeId() {
    return this.selectedNodeIds.length > 0 ? this.selectedNodeIds[this.selectedNodeIds.length - 1] : void 0;
  }
  connectedCallback() {
    super.connectedCallback();
    this.service = getService("MaterialService");
    this.service.addEventListener("hoops-material-selection-change", this.handleSelectionChange);
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    this.service.removeEventListener("hoops-material-selection-change", this.handleSelectionChange);
  }
  render() {
    return b`
      <h2 class="title">
        Custom Shaders
        <hoops-icon-button @click=${() => this.dispatchEvent(new Event("closePanel"))}>
          <hoops-icon icon="downIcon"></hoops-icon>
        </hoops-icon-button>
      </h2>
      <div class="container">
        <hoops-accordion>
          <span slot="header">Mesh Description</span>
          <hoops-mesh-description
            .nodeId=${this.lastSelectedNodeId}
            .service=${this.service}
            slot="content"
          ></hoops-mesh-description>
        </hoops-accordion>
        <hoops-accordion>
          <span slot="header">Material Description</span>
          <hoops-material-description
            .nodeId=${this.lastSelectedNodeId}
            .service=${this.service}
            slot="content"
          ></hoops-material-description>
        ...
        <hoops-accordion>
          <span slot="header">Shader Editor</span>
          <hoops-tabs selectedIndex="0" position="top" slot="content">
            <hoops-tab label="Vertex Shader" value="vertex">
              <hoops-shader-editor
                id="vertexEditor"
                .value=${localStorage.getItem("vertexShader") || ""}
              ></hoops-shader-editor>
            </hoops-tab>
            <hoops-tab label="Fragment Shader" value="fragment">
              <hoops-shader-editor
                id="fragmentEditor"
                .value=${localStorage.getItem("fragmentShader") || ""}
              ></hoops-shader-editor>
            </hoops-tab>
            <hoops-tab label="Uniforms" value="uniforms">
              <hoops-shader-options-editor
                id="uniformsEditor"
                .value=${localStorage.getItem("uniformsDescription") || ""}
              ></hoops-shader-options-editor>
            </hoops-tab>
          </hoops-tabs>
        </hoops-accordion>
        <div>
          <p id="feedback" class="${this.setShaderResult.status}">
            ${this.setShaderResult.message}
          </p>
        </div>
      </div>
      <div class="actions">
        <hoops-button
          ?disabled=${this.selectedNodeIds.length === 0}
          @click=${() => {
      localStorage.setItem("vertexShader", this.vertexEditor.value);
      localStorage.setItem("fragmentShader", this.fragmentEditor.value);
      localStorage.setItem("uniformsDescription", this.uniformsEditor.value);
      let uniforms = {};
      try {
        uniforms = JSON.parse(this.uniformsEditor.value);
      } catch (error) {
        return;
      }
      this.service.setNodesShader(
        this.selectedNodeIds,
        this.vertexEditor.value,
        this.fragmentEditor.value,
        uniforms
      ).then(() => {
        this.setShaderResult = {
          status: "success",
          message: "Shader set successfully"
        };
      }).catch((error) => {
        this.setShaderResult = {
          status: "error",
          message: `Error while setting shader: ${(error == null ? void 0 : error.data) || "Unknown error"}`
        };
      });
    }}
          >Set Shader</hoops-button
        >
      </div>
    `;
  }
};
HoopsCustomShaderPanelElement.styles = [
  i$1`
      :host {
        height: 100%;
        display: flex;
        flex-direction: column;
        --local-bg-color: var(--hoops-neutral-background-50, #f0f0f0);
      }
      ...
      .container {
        ...
        overflow-y: auto;
        flex-grow: 1;
        --hoops-neutral-background-50: color-mix(in srgb, var(--local-bg-color) 50%, transparent);
      }
      ...
      hoops-button {
        ...
        border: 2px solid var(--hoops-foreground, #303030);
      }
...
__decorateClass$2([
  e("#vertexEditor")
], HoopsCustomShaderPanelElement.prototype, "vertexEditor", 2);
__decorateClass$2([
  e("#fragmentEditor")
], HoopsCustomShaderPanelElement.prototype, "fragmentEditor", 2);
__decorateClass$2([
  e("#uniformsEditor")
], HoopsCustomShaderPanelElement.prototype, "uniformsEditor", 2);
__decorateClass$2([
  r()
], HoopsCustomShaderPanelElement.prototype, "selectedNodeIds", 2);
__decorateClass$2([
  r()
], HoopsCustomShaderPanelElement.prototype, "setShaderResult", 2);
HoopsCustomShaderPanelElement = __decorateClass$2([
  t$1("hoops-custom-shader-panel")
], HoopsCustomShaderPanelElement);
...
EditorState.phrases = /* @__PURE__ */ Facet.define({
  compare(a, b2) {
    ...
    return kA.length == kB.length && kA.every((k) => a[k] == b2[k]);
  }
});
...
function onSameLine(a, b2) {
  let posA = a.coordsIn(0, 1), posB = b2.coordsIn(0, 1);
...
class TileUpdate {
  ...
  emit(from, to) {
    ...
    let b2 = this.builder, markCount = 0;
      ...
      span: (from2, to2, active, openStart) => {
        for (let pos = from2; pos < to2; ) {
          ...
          if (chars == null) {
            ...
            b2.ensureLine(pendingLineAttrs);
            b2.addText(chars, active, openStart);
            pos += chars.length;
          }
          pendingLineAttrs = null;
        }
...
function findChangedWrappers(a, b2, diff) {
...
function findDiff(a, b2, preferredPos, preferredSide) {
  ...
  let from = 0;
  while (from < minLen && a.charCodeAt(from) == b2.charCodeAt(from))
    from++;
  if (from == minLen && a.length == b2.length)
    return null;
  ...
  if (toA < from && a.length < b2.length) {
...
class DecorationComparator2 {
  ...
  comparePoint(from, to, a, b2) {
    if (from < to || a && a.heightRelevant || b2 && b2.heightRelevant)
...
class EditContextManager {
  constructor(view) {
    ...
    this.handlers.characterboundsupdate = (e2) => {
      let rects = [], prev = null;
      for (let i = this.toEditorPos(e2.rangeStart), end = this.toEditorPos(e2.rangeEnd); i < end; i++) {
...
const completionConfig = /* @__PURE__ */ Facet.define({
  combine(configs) {
    return combineConfig(configs, {
      ...
      icons: (a, b2) => a && b2,
      tooltipClass: (a, b2) => (c) => joinClass(a(c), b2(c)),
      optionClass: (a, b2) => (c) => joinClass(a(c), b2(c)),
      addToOptions: (a, b2) => a.concat(b2),
      filterStrict: (a, b2) => a || b2
    });
  }
});
...
class CompletionTooltip {
  ...
  createListBox(options, id, range) {
    ...
    for (let i = range.from; i < range.to; i++) {
      let { completion, match } = options[i], { section: section2 } = completion;
      if (section2) {
...
function sortOptions(active, state) {
  ...
  if (sections) {
    ...
    let cmp = (a, b2) => {
      return (a.rank === "dynamic" && b2.rank === "dynamic" ? dynamicSectionScore[b2.name] - dynamicSectionScore[a.name] : 0) || (typeof a.rank == "number" ? a.rank : 1e9) - (typeof b2.rank == "number" ? b2.rank : 1e9) || (a.name < b2.name ? -1 : 1);
    };
...
const glslLanguage = StreamLanguage.define({
  ...
  token(stream, state) {
    ...
    if (stream.sol() && stream.match(
      /#\s*(define|undef|if|ifdef|ifndef|else|elif|endif|error|pragma|extension|version|line)\b/
    )) {
      stream.skipToEnd();
      return "meta";
    }
...
const glslDarkTheme = EditorView.theme(
  {
    "&": {
...
const glslCompletions = [
  // Types
  { label: "void", type: "type", detail: "No return type" },
  { label: "bool", type: "type", detail: "Boolean type" },
  { label: "int", type: "type", detail: "Signed integer" },
  { label: "uint", type: "type", detail: "Unsigned integer" },
  { label: "float", type: "type", detail: "Floating-point number" },
  { label: "vec2", type: "type", detail: "2-component float vector" },
  { label: "vec3", type: "type", detail: "3-component float vector" },
  { label: "vec4", type: "type", detail: "4-component float vector" },
  { label: "mat2", type: "type", detail: "2x2 float matrix" },
  { label: "mat3", type: "type", detail: "3x3 float matrix" },
  { label: "mat4", type: "type", detail: "4x4 float matrix" },
  { label: "sampler2D", type: "type", detail: "2D texture sampler" },
  { label: "samplerCube", type: "type", detail: "Cube map texture sampler" },
  { label: "sampler3D", type: "type", detail: "3D texture sampler" },
  // Qualifiers
  { label: "uniform", type: "keyword", detail: "Uniform variable qualifier" },
  { label: "attribute", type: "keyword", detail: "Vertex attribute qualifier" },
  ...
  { label: "inout", type: "keyword", detail: "In/out parameter qualifier" },
  ...
  // Common functions
  { label: "texture", type: "function", detail: "Sample a texture" },
  { label: "texture2D", type: "function", detail: "Sample a 2D texture (deprecated)" },
  { label: "textureCube", type: "function", detail: "Sample a cube texture" },
  { label: "mix", type: "function", detail: "Linear interpolation" },
  { label: "clamp", type: "function", detail: "Clamp value to range" },
  { label: "step", type: "function", detail: "Step function" },
  { label: "smoothstep", type: "function", detail: "Smooth Hermite interpolation" },
  { label: "length", type: "function", detail: "Vector length" },
  { label: "distance", type: "function", detail: "Distance between two points" },
  { label: "dot", type: "function", detail: "Dot product" },
  { label: "cross", type: "function", detail: "Cross product" },
  { label: "normalize", type: "function", detail: "Normalize vector" },
  { label: "reflect", type: "function", detail: "Reflection vector" },
  { label: "refract", type: "function", detail: "Refraction vector" },
  { label: "sin", type: "function", detail: "Sine" },
  { label: "cos", type: "function", detail: "Cosine" },
  { label: "tan", type: "function", detail: "Tangent" },
  { label: "asin", type: "function", detail: "Arc sine" },
  { label: "acos", type: "function", detail: "Arc cosine" },
  { label: "atan", type: "function", detail: "Arc tangent" },
  { label: "pow", type: "function", detail: "Power function" },
  { label: "exp", type: "function", detail: "Exponential" },
  { label: "log", type: "function", detail: "Natural logarithm" },
  { label: "exp2", type: "function", detail: "Base-2 exponential" },
  { label: "log2", type: "function", detail: "Base-2 logarithm" },
  { label: "sqrt", type: "function", detail: "Square root" },
  { label: "inversesqrt", type: "function", detail: "Inverse square root" },
  { label: "abs", type: "function", detail: "Absolute value" },
  { label: "sign", type: "function", detail: "Sign function" },
  { label: "floor", type: "function", detail: "Floor function" },
  { label: "ceil", type: "function", detail: "Ceiling function" },
  { label: "fract", type: "function", detail: "Fractional part" },
  { label: "mod", type: "function", detail: "Modulo operation" },
  { label: "min", type: "function", detail: "Minimum value" },
  { label: "max", type: "function", detail: "Maximum value" },
  { label: "radians", type: "function", detail: "Degrees to radians" },
  { label: "degrees", type: "function", detail: "Radians to degrees" },
  { label: "dFdx", type: "function", detail: "Partial derivative in x" },
  { label: "dFdy", type: "function", detail: "Partial derivative in y" },
  { label: "fwidth", type: "function", detail: "Sum of absolute derivatives" },
  // Built-in variables
  { label: "gl_Position", type: "variable", detail: "Vertex position output" },
  { label: "gl_FragCoord", type: "variable", detail: "Fragment coordinates" },
  { label: "gl_FragColor", type: "variable", detail: "Fragment color output (deprecated)" },
  { label: "gl_FragData", type: "variable", detail: "Fragment data output" },
  { label: "gl_PointSize", type: "variable", detail: "Point size" },
  { label: "gl_VertexID", type: "variable", detail: "Vertex index" },
  { label: "gl_InstanceID", type: "variable", detail: "Instance index" },
  { label: "gl_FrontFacing", type: "variable", detail: "Front-facing fragment" },
  { label: "gl_PointCoord", type: "variable", detail: "Point sprite coordinates" },
  {
    label: "tc_um4_projection_matrix",
    type: "variable",
    detail: "Projection matrix - Transforms from view space to clip space (perspective or orthographic)"
  },
  {
    label: "tc_um4_view_matrix",
    type: "variable",
    detail: "View matrix - Transforms from world space to view/camera space"
  },
  {
    label: `tc_um4_model_matrix`,
    type: "variable",
    detail: "Model matrix - Transforms from object space to world space (single matrix mode, used on Safari) "
  },
  {
    label: `tc_um3_normal_matrix`,
    type: "variable",
    detail: "Normal matrix - Inverse transpose of model matrix for correct normal transformation"
  },
  {
    label: `tc_uv4_model_matrices[]`,
    type: "variable",
    detail: "Batch model matrices - Array of packed model matrices for batched rendering (3 vec4 per matrix)"
  },
  {
    label: `tc_uiv2_matrix_offsets`,
    type: "variable",
    detail: "Matrix offsets - Start/end indices in the model matrices array"
  },
  {
    label: `tc_uv3_explode_translation`,
    type: "variable",
    detail: "Explode translation - Translation offset for exploded view mode"
  },
  {
    label: `tc_uf_light_mix`,
    type: "variable",
    detail: "Light mix factor - Blend factor between lit and unlit color"
  },
  {
    label: `tc_uv3_ambient_light_color`,
    type: "variable",
    detail: "Ambient light color - Global ambient illumination color"
  },
  {
    label: `tc_uv3_dir_light_position[]`,
    type: "variable",
    detail: "Light directions - Normalized direction vectors pointing toward the light source"
  },
  {
    label: `tc_uv3_dir_light_color[]`,
    type: "variable",
    detail: "Light colors - RGB color and intensity of each directional light"
  },
  {
    label: `tc_uv3_point_light_position[]`,
    type: "variable",
    detail: "Light positions - World-space position of each point light"
  },
  {
    label: `tc_uv3_point_light_color[]`,
    type: "variable",
    detail: "Light colors - RGB color of each point light"
  },
  {
    label: `tc_uf_point_light_power[]`,
    type: "variable",
    detail: "Light power/intensity - Brightness multiplier for each point light"
  },
  {
    label: `tc_uf_point_light_decay[]`,
    type: "variable",
    detail: "Light decay - Distance attenuation exponent for each point light"
  },
  {
    label: `tc_us2_light_depth_map[]`,
    type: "variable",
    detail: "Shadow depth maps - Depth textures for shadow calculations"
  },
  {
    label: `tc_um4_light_view_projection_matrix[]`,
    type: "variable",
    detail: "Light VP matrices - View-projection matrices for projecting into shadow map space"
  },
  // Attributes (Vertex Inputs)
  {
    label: "tc_av4_vertex",
    type: "variable",
    detail: "Vertex position - 3D coordinates of the vertex (w=1.0)"
  },
  {
    label: "tc_av3_normal",
    type: "variable",
    detail: "Vertex normal - Normal vector for lighting calculations"
  },
  {
    label: "tc_av4_base_color",
    type: "variable",
    detail: "Per-vertex color - RGBA color attached to the vertex"
  },
  {
    label: "tc_av2_texture_coords",
    type: "variable",
    detail: "Texture coordinates - UV mapping coordinates"
  },
  {
    label: "tc_af_batch_index",
    type: "variable",
    detail: "Batch index - Index into the model matrix array for batching"
  },
  {
    label: "tc_av4_matrix_col1",
    type: "variable",
    detail: "Instance matrix column 1 - First column of per-instance transform"
  },
  {
    label: "tc_av4_matrix_col2",
    type: "variable",
    detail: "Instance matrix column 2 - Second column of per-instance transform"
  },
  {
    label: "tc_av4_matrix_col3",
    type: "variable",
    detail: "Instance matrix column 3 - Third column of per-instance transform"
  },
  {
    label: "tc_af_line_pattern_offset",
    type: "variable",
    detail: "Line pattern offset - Position within the line stipple pattern"
  },
  {
    label: "tc_af_line_jitter_offset",
    type: "variable",
    detail: "Jitter offset - Offset for line jitter effect"
  },
  // Phong Material
  {
    label: "tc_uv4_base_color",
    type: "variable",
    detail: "Base/diffuse color - Primary surface color (RGB) with alpha"
  },
  {
    label: "tc_uf_opacity",
    type: "variable",
    detail: "Opacity - Overall material transparency (0.0 = transparent, 1.0 = opaque)"
  },
  {
    label: "tc_uv2_specular_mix_and_gloss",
    type: "variable",
    detail: "Specular parameters - x = specular intensity, y = glossiness/shininess"
  },
  {
    label: "tc_uv3_specular_color_factor",
    type: "variable",
    detail: "Specular color - Tint color for specular highlights"
  },
  {
    label: "tc_uv3_emissive_color",
    type: "variable",
    detail: "Emissive color - Self-illumination color (not affected by lighting)"
  },
  {
    label: "tc_uv3_ambient_color",
    type: "variable",
    detail: "Material's response to ambient light"
  },
  {
    label: "tc_uf_ambient_mix",
    type: "variable",
    detail: "Ambient mix - Blend factor for ambient contribution"
  },
  {
    label: "tc_ub_flat",
    type: "variable",
    detail: "Flat shading - Use face normal instead of interpolated vertex normals"
  },
  {
    label: "tc_ub_auto_flip",
    type: "variable",
    detail: "Auto-flip normals - Automatically flip back-facing normals toward camera"
  },
  // PBR Metallic-Roughness
  {
    label: "tc_uv2_metallic_roughness",
    type: "variable",
    detail: "Metallic/Roughness factors - x = metallic (0=dielectric, 1=metal), y = roughness"
  },
  {
    label: "tc_us2_metallic_roughness_map",
    type: "variable",
    detail: "Metallic-roughness texture - G channel = roughness, B channel = metallic"
  },
  {
    label: "tc_uf_alpha_cutoff",
    type: "variable",
    detail: "Alpha cutoff threshold - Pixels with alpha below this value are discarded"
  },
  // Occlusion
  {
    label: "tc_us2_occlusion_map",
    type: "variable",
    detail: "Ambient occlusion texture - R channel contains occlusion data"
  },
  {
    label: "tc_uf_occlusion_strength",
    type: "variable",
    detail: "Occlusion strength - Multiplier for occlusion effect (0.0-1.0)"
  },
  // Clearcoat Extension (KHR_materials_clearcoat)
  {
    label: "tc_uv2_clearcoat_intensity_roughness",
    type: "variable",
    detail: "Clearcoat parameters - x = intensity (0-1), y = roughness factor"
  },
  {
    label: "tc_us2_clearcoat_intensity_map",
    type: "variable",
    detail: "Clearcoat intensity texture"
  },
  {
    label: "tc_us2_clearcoat_roughness_map",
    type: "variable",
    detail: "Clearcoat roughness texture"
  },
  {
    label: "tc_us2_clearcoat_normal_map",
    type: "variable",
    detail: "Clearcoat normal map - Independent normal map for clearcoat layer"
  },
  // Specular Extension (KHR_materials_specular)
  {
    label: "tc_uf_specular_factor",
    type: "variable",
    detail: "Specular factor - Strength of specular reflection"
  },
  {
    label: "tc_us2_specular_map",
    type: "variable",
    detail: "Specular texture - Alpha channel contains specular factor"
  },
  {
    label: "tc_us2_specular_color_map",
    type: "variable",
    detail: "Specular color texture"
  },
  // Specular-Glossiness Workflow (KHR_materials_pbrSpecularGlossiness)
  {
    label: "tc_uf_glossiness_factor",
    type: "variable",
    detail: "Glossiness factor - Surface smoothness (0=rough, 1=smooth)"
  },
  {
    label: "tc_uv4_glossiness_diffuse_factor",
    type: "variable",
    detail: "Diffuse factor - Base diffuse color (RGBA)"
  },
  {
    label: "tc_uv3_glossiness_specular_factor",
    type: "variable",
    detail: "Specular factor - Specular reflection color"
  },
  {
    label: "tc_us2_glossiness_diffuse_map",
    type: "variable",
    detail: "Diffuse texture - sRGB diffuse color map"
  },
  {
    label: "tc_us2_glossiness_specular_map",
    type: "variable",
    detail: "Specular-glossiness texture - RGB = specular, A = glossiness"
  },
  // Image Based Lighting (IBL)
  {
    label: "tc_uv3_ibl_diffuse_sh[9]",
    type: "variable",
    detail: "Diffuse spherical harmonics - 9 SH coefficients for irradiance"
  },
  {
    label: "tc_us2_ibl_specular_brdf",
    type: "variable",
    detail: "BRDF LUT - Pre-integrated BRDF lookup table"
  },
  {
    label: "tc_usc_ibl_specular_map",
    type: "variable",
    detail: "Specular environment map - Pre-filtered cubemap for reflections"
  },
  {
    label: "tc_uf_ibl_specular_map_levels",
    type: "variable",
    detail: "Mipmap levels - Number of mip levels in specular cubemap"
  },
  {
    label: "tc_uf_ibl_intensity",
    type: "variable",
    detail: "IBL intensity - Overall brightness multiplier for environment lighting"
  },
  {
    label: "tc_um3_ibl_matrix",
    type: "variable",
    detail: "Environment rotation - Rotation matrix for the environment map"
  },
  // Textures - Diffuse/Albedo
  {
    label: "tc_us2_texture",
    type: "variable",
    detail: "Diffuse/albedo texture - Base color texture map"
  },
  {
    label: "tc_uv3_texture_matrix_row0",
    type: "variable",
    detail: "Texture matrix row 0 - First row of 2D texture transform"
  },
  {
    label: "tc_uv3_texture_matrix_row1",
    type: "variable",
    detail: "Texture matrix row 1 - Second row of 2D texture transform"
  },
  // Additional Texture Maps
  {
    label: "tc_us2_normal_map",
    type: "variable",
    detail: "Normal map - Tangent-space normal texture for surface detail"
  },
  {
    label: "tc_us2_emissive_map",
    type: "variable",
    detail: "Emissive texture - Self-illumination color map"
  },
  {
    label: "tc_us2_sphere_map",
    type: "variable",
    detail: "Sphere/environment map - Spherical reflection texture"
  },
  {
    label: "tc_uf_mirror",
    type: "variable",
    detail: "Mirror factor - Reflection intensity for sphere mapping"
  },
  // Cutting Planes
  {
    label: "tc_ui_cutting_sections",
    type: "variable",
    detail: "Active sections count - Number of active cutting sections"
  },
  {
    label: "tc_uv4_cutting_planes[]",
    type: "variable",
    detail: "Cutting plane equations - Array of plane equations (ax + by + cz + d = 0)"
  },
  // Point Rendering
  {
    label: "tc_uf_point_size",
    type: "variable",
    detail: "Point size - Size of rendered points in pixels (sets gl_PointSize)"
  },
  // Line Rendering
  {
    label: "tc_us2_line_pattern",
    type: "variable",
    detail: "Line pattern texture - 1D texture for stipple/dash pattern"
  },
  {
    label: "tc_uf_line_pattern_inverse_length",
    type: "variable",
    detail: "Pattern scale - Inverse of pattern length for UV calculation"
  },
  // Line Jitter
  {
    label: "tc_uv2_jitter_diameter_and_frequency",
    type: "variable",
    detail: "Jitter parameters - x = jitter diameter, y = frequency"
  },
  // Gooch Shading
  {
    label: "tc_uf_gooch_blue",
    type: "variable",
    detail: "Cool color factor - Intensity of blue/cool tones in shadows"
  },
  {
    label: "tc_uf_gooch_yellow",
    type: "variable",
    detail: "Warm color factor - Intensity of yellow/warm tones in lit areas"
  },
  {
    label: "tc_uf_gooch_base_color_prominence",
    type: "variable",
    detail: "Base color mix - How much the original color shows through"
  },
  {
    label: "tc_uf_gooch_luminance_shift_strength",
    type: "variable",
    detail: "Luminance shift - Strength of luminance-based color shifting"
  },
  // Toon/Cel Shading
  {
    label: "tc_us2_toon_map",
    type: "variable",
    detail: "Toon ramp texture - 1D gradient texture defining shading bands"
  },
  {
    label: "tc_uf_toon_specular_factor",
    type: "variable",
    detail: "Toon specular - Specular highlight intensity"
  },
  // Miscellaneous
  {
    label: "tc_uv2_viewport_size",
    type: "variable",
    detail: "Viewport dimensions - Width and height in pixels"
  },
  {
    label: "tc_ub_projection_is_ortho",
    type: "variable",
    detail: "Projection type - True for orthographic, false for perspective"
  },
  {
    label: "tc_uv4_ground_plane",
    type: "variable",
    detail: "Ground plane equation - Plane for planar reflections"
  },
  {
    label: "tc_uv2_reflection_attenuation",
    type: "variable",
    detail: "Reflection falloff - Attenuation parameters for reflections"
  }
];
...
let HoopsShaderEditorElement = class extends i$2 {
  constructor() {
    super(...arguments);
    this.language = "glsl";
    this.readOnly = false;
  ...
  get value() {
    var _a2;
    return ((_a2 = this._editorView) == null ? void 0 : _a2.state.doc.toString()) ?? this._pendingValue;
  }
  set value(newValue) {
    const oldValue = this._pendingValue;
    this._pendingValue = newValue;
    if (this._editorView && newValue !== this._editorView.state.doc.toString()) {
   ...
   * Cleans up the CodeMirror editor instance.
   * @internal
   */
  disconnectedCallback() {
    super.disconnectedCallback();
  ...
  /**
   * Lifecycle callback called after the first render.
  ...
  /**
   * Lifecycle callback called when properties change.
   * Updates editor configuration based on property changes.
   *
   * @param changedProperties - Map of changed properties
   * @internal
   */
  ...
  /**
   * Creates the CodeMirror editor instance with GLSL configuration.
   * @internal
   */
  _createEditor() {
    if (this._editorView || !this._editorContainer) {
      return;
    }
    const extensions = [
      lineNumbers(),
  ...
  /**
   * Destroys the CodeMirror editor instance.
   * @internal
   */
  _destroyEditor() {
    if (this._editorView) {
   ...
   * Dispatches a change event with the new content.
   * @internal
   */
  _handleChange() {
    var _a2;
    const newValue = ((_a2 = this._editorView) == null ? void 0 : _a2.state.doc.toString()) ?? "";
    this._pendingValue = newValue;
    this.dispatchEvent(
      new CustomEvent("hoops-shader-editor-change", {
        detail: newValue,
        bubbles: true,
        composed: true
      })
  ...
  focus() {
    var _a2;
    (_a2 = this._editorView) == null ? void 0 : _a2.focus();
  }
  /**
   * Gets the current selection range in the editor.
   *
   * @returns The selection range with from and to positions, or null if no editor exists
   */
  getSelection() {
    if (!this._editorView) {
      return null;
  ...
  /** @internal */
  render() {
    return b`<div class="editor-container"></div>`;
  }
};
HoopsShaderEditorElement.styles = [
  i$1`
      :host {
        display: block;
        height: var(--hoops-shader-editor-height, 100%);
        min-height: var(--hoops-shader-editor-min-height, 100px);
        max-height: var(--hoops-shader-editor-max-height, none);
...
__decorateClass$1([
  n({ type: String })
], HoopsShaderEditorElement.prototype, "value", 1);
__decorateClass$1([
  n({ type: String })
], HoopsShaderEditorElement.prototype, "language", 2);
__decorateClass$1([
  n({ type: Boolean, attribute: "read-only" })
], HoopsShaderEditorElement.prototype, "readOnly", 2);
__decorateClass$1([
  n({ type: String })
], HoopsShaderEditorElement.prototype, "placeholder", 2);
__decorateClass$1([
  e(".editor-container")
], HoopsShaderEditorElement.prototype, "_editorContainer", 2);
HoopsShaderEditorElement = __decorateClass$1([
  t$1("hoops-shader-editor")
], HoopsShaderEditorElement);
...
const shaderOptionsCompletions = [
  // Root level
  { label: '"uniforms"', type: "property", detail: "Uniform definitions" },
  // Uniform types
  ...uniformTypeNames.map((type) => ({
    label: `"${type}"`,
    type: "keyword",
    detail: `Uniform type: ${type}`
  })),
  // Common property names
  { label: '"type"', type: "property", detail: "Uniform type" },
  { label: '"values"', type: "property", detail: "Uniform value(s)" },
  { label: '"isArray"', type: "property", detail: "Whether uniform is an array" }
];
function jsonCompletionSource(context) {
  ...
  return {
    from: word.from,
    options: shaderOptionsCompletions,
    validFor: /^["\w]*$/
  };
}
...
let HoopsShaderOptionsEditorElement = class extends i$2 {
  constructor() {
    super(...arguments);
    this.readOnly = false;
    this._statusMessage = "";
  ...
  /**
   * Creates the CodeMirror editor instance with JSON configuration.
   * @internal
   */
  _createEditor() {
    if (this._editorView || !this._editorContainer) {
  ...
  /**
   * Handles changes to the editor content.
   * Dispatches a change event and validates the JSON.
   * @internal
   */
  _handleChange() {
    var _a2;
    ...
    this._pendingValue = newValue;
    this.dispatchEvent(
      new CustomEvent("hoops-shader-options-editor-change", {
        detail: newValue,
        bubbles: true,
        composed: true
      })
   ...
   * Dispatches valid or error events based on validation result.
   * @internal
   */
  _validateJson() {
    var _a2;
    const content2 = ((_a2 = this._editorView) == null ? void 0 : _a2.state.doc.toString()) ?? this._pendingValue;
    if (!content2.trim()) {
      this._isValid = true;
      this._statusMessage = "Empty";
      return;
    }
    try {
      const parsed = JSON.parse(content2);
      this._isValid = true;
      this._statusMessage = "Valid JSON";
      this.dispatchEvent(
        new CustomEvent("hoops-shader-options-editor-valid", {
          detail: parsed,
          bubbles: true,
          composed: true
        })
      ...
      this._isValid = false;
      this._statusMessage = e2 instanceof Error ? e2.message : "Invalid JSON";
      this.dispatchEvent(
        new CustomEvent("hoops-shader-options-editor-error", {
          detail: this._statusMessage,
          bubbles: true,
          composed: true
        })
      );
  ...
  /**
   * Gets the parsed SetShaderOptions object if the JSON is valid.
   *
   * @returns The parsed options or null if invalid
   */
  getParsedOptions() {
    try {
    ...
    return b`
      <div class="editor-wrapper">
        ...
        <div class="status-bar">
          <span class="${this._isValid ? "status-valid" : "status-error"}"
            >${this._statusMessage}</span
          >
        </div>
      </div>
    `;
...
HoopsShaderOptionsEditorElement.styles = [
  i$1`
      :host {
        display: block;
        height: var(--hoops-shader-options-editor-height, 100%);
        min-height: var(--hoops-shader-options-editor-min-height, 100px);
        max-height: var(--hoops-shader-options-editor-max-height, none);
        border-radius: var(--hoops-shader-options-editor-border-radius, 4px);
        overflow: hidden;
      }
      ...
      .status-bar {
        ...
        background: var(--hoops-neutral-background-50, #21252b);
        border-top: 1px solid var(--hoops-neutral-foreground-20, #181a1f);
        font-size: 0.75rem;
...
__decorateClass([
  n({ type: String })
], HoopsShaderOptionsEditorElement.prototype, "value", 1);
__decorateClass([
  n({ type: Boolean, attribute: "read-only" })
], HoopsShaderOptionsEditorElement.prototype, "readOnly", 2);
__decorateClass([
  n({ type: String })
], HoopsShaderOptionsEditorElement.prototype, "_statusMessage", 2);
__decorateClass([
  n({ type: Boolean })
], HoopsShaderOptionsEditorElement.prototype, "_isValid", 2);
__decorateClass([
  e(".editor-container")
], HoopsShaderOptionsEditorElement.prototype, "_editorContainer", 2);
HoopsShaderOptionsEditorElement = __decorateClass([
  t$1("hoops-shader-options-editor")
], HoopsShaderOptionsEditorElement);
const viewerTag = document.getElementById("viewer");
const section = document.getElementById("shader-panel");
let hwv;
  ...
  const p = new Promise((resolve, reject) => {
    ...
    request.onload = function() {
      if (request.status === 200) {
        ...
        reject(new Error(`Failed to load image: ${filename}, status: ${request.status}`));
      }
    };
...
viewerTag.addEventListener("hwvReady", (event) => {
  const viewer = event.detail;
  hwv = viewer;
  registerService(new MaterialService(viewer));
  const customShaderPanel = document.createElement("hoops-custom-shader-panel");
  section.appendChild(customShaderPanel);
});
viewerTag.addEventListener("hwvSceneReady", async () => {
  const imageId = await loadImage("images/textures/bricks.png");
  window.bricksImageId = imageId;
  console.log("Bricks texture loaded with image id: ", imageId);
});
