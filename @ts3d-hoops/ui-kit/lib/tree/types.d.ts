 ...
 */
export type BaseMouseEvent = Pick<MouseEvent, 'altKey' | 'button' | 'buttons' | 'clientX' | 'clientY' | 'ctrlKey' | 'metaKey' | 'movementX' | 'movementY' | 'offsetX' | 'offsetY' | 'pageX' | 'pageY' | 'screenX' | 'screenY' | 'shiftKey'>;
/**
...
export interface TreeContext {
    ...
    getContent(context: TreeContext, key: number, selected?: boolean, nodeData?: unknown): HTMLTemplateResult | typeof nothing;
}
