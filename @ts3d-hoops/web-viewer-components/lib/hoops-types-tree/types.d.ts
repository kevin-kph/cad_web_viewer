...
import { BranchVisibility, BranchVisibilityOptions, GenericType } from '@ts3d-hoops/web-viewer';
...
export interface IModel {
    ...
    getBranchVisibility: (nodeId: number, options?: BranchVisibilityOptions) => BranchVisibility;
}
/**
 ...
 */
export type TypesTreeNodeFactory = (treeContext: TreeContext, model: IModel, nodeId: number, selected?: boolean, nodeData?: unknown) => HTMLTemplateResult | typeof nothing;
