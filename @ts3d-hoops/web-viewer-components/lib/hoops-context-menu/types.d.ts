import { CallbackMap, Color, ElementType, GenericType, LayerId, LayerName, NodeId, SheetManager, Operators, core, Selection } from '@ts3d-hoops/web-viewer';
/**
...
export interface IContextMenuModel {
    ...
    setNodesVisibility(nodeIds: NodeId[], visibility: boolean, initiallyHiddenStayHidden?: boolean | null): void;
