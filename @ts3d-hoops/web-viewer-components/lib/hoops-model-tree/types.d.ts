import { BranchVisibilityOptions, BranchVisibility as ComBranchVisibility, NodeType } from '@ts3d-hoops/web-viewer';
...
export interface IModel {
    ...
    getBranchVisibility: (nodeId: number, options?: BranchVisibilityOptions) => ComBranchVisibility;
}
/**
 ...
 */
export type ModelTreeNodeFactory = (treeContext: TreeContext, model: IModel, nodeId: number, selected?: boolean, nodeData?: unknown) => HTMLTemplateResult | typeof nothing;
export type BranchVisibility = 'Hidden' | 'Shown' | 'Mixed' | 'Unknown';
export declare function branchVisibilityFromComBranchVisibility(value: ComBranchVisibility): BranchVisibility;
