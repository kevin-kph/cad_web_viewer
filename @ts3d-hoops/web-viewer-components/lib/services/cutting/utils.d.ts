 ...
 * ```
 */
export declare function convertHwvCuttingPlaneToCuttingPlane(hwvPlane: HwvCuttingPlane): CuttingPlane;
/**
 ...
 * ```
 */
export declare function convertHwvSectionToSection(hwvSection: core.ICuttingSection, hidden: boolean): Section;
/**
 ...
 * ```
 */
export declare function convertCuttingSections(cuttingManager: core.ICuttingManager, hidden?: boolean[]): Section[];
/**
 ...
 */
export declare function getReferenceGeometry(plane: Plane, position: Point3, modelBounding: Box): Point3[];
/**
 ...
 */
export declare function getPlaneCenter(plane: Plane, bounding: Box): Point3;
