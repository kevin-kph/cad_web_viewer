 ...
 */
export type LayerTreeElementFactory = (listContext: ListContext, layersContainer: ILayersContainer, layerId: number, selected?: boolean, selectedNodes?: number[]) => HTMLTemplateResult | typeof nothing;
